...
const buildCorrespondenceSourcesCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Correspondence Sources',
...
export function createCorrespondenceSourcesCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildCorrespondenceSourcesCrudOpenApi(options)
}
