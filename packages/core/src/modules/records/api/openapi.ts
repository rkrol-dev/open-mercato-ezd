...
const buildRecordsCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Records',
...
export function createRecordsCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildRecordsCrudOpenApi(options)
}
