...
export class Migration20260201105013 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "records_documents" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "title" text not null, "kind" text null, "access_level" text null, "incoming_shipment_id" uuid null, "attachment_ids" text[] not null default '{}', "disposal_status" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "records_documents_pkey" primary key ("id"));`);
    this.addSql(`create index "records_documents_shipment_idx" on "records_documents" ("incoming_shipment_id");`);
    this.addSql(`create index "records_documents_org_tenant_idx" on "records_documents" ("organization_id", "tenant_id");`);

    this.addSql(`create table "records_incoming_shipments" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "receiving_org_unit_id" uuid not null, "receiving_org_unit_symbol" text not null, "subject" text not null, "sender_id" uuid null, "sender_display_name" text null, "sender_anonymous" boolean not null default false, "delivery_method" text not null, "status" text not null, "received_at" timestamptz not null, "rpw_number" text null, "rpw_sequence" int null, "attachment_ids" text[] not null default '{}', "posted_at" timestamptz null, "sender_reference" text null, "remarks" text null, "document_date" timestamptz null, "document_sign" text null, "access_level" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "records_incoming_shipments_pkey" primary key ("id"));`);
    this.addSql(`create index "records_incoming_shipments_org_unit_idx" on "records_incoming_shipments" ("receiving_org_unit_id");`);
    this.addSql(`create index "records_incoming_shipments_received_at_idx" on "records_incoming_shipments" ("received_at");`);
    this.addSql(`create index "records_incoming_shipments_status_idx" on "records_incoming_shipments" ("status");`);
    this.addSql(`create index "records_incoming_shipments_rpw_number_idx" on "records_incoming_shipments" ("rpw_number");`);
    this.addSql(`create index "records_incoming_shipments_org_tenant_idx" on "records_incoming_shipments" ("organization_id", "tenant_id");`);

    this.addSql(`create table "records_jrwa_classes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "name" text not null, "description" text null, "parent_id" uuid null, "retention_years" int null, "retention_category" text null, "archival_package_variant" text null, "version" int not null, "is_active" boolean not null default true, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "records_jrwa_classes_pkey" primary key ("id"));`);
    this.addSql(`create index "records_jrwa_classes_is_active_idx" on "records_jrwa_classes" ("is_active");`);
    this.addSql(`create index "records_jrwa_classes_parent_idx" on "records_jrwa_classes" ("parent_id");`);
    this.addSql(`create index "records_jrwa_classes_version_code_idx" on "records_jrwa_classes" ("version", "code");`);
    this.addSql(`create index "records_jrwa_classes_org_tenant_idx" on "records_jrwa_classes" ("organization_id", "tenant_id");`);

    this.addSql(`create table "records_rpw_sequences" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "receiving_org_unit_id" uuid not null, "year" int not null, "current_value" int not null default 0, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "records_rpw_sequences_pkey" primary key ("id"));`);
    this.addSql(`create index "records_rpw_sequences_unique_idx" on "records_rpw_sequences" ("organization_id", "tenant_id", "receiving_org_unit_id", "year");`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "mikro_orm_migrations_correspondence_sources" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
